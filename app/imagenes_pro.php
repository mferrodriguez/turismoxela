<?php
    ...
    case 1:
        ...
        if (!mysqli_query($connect, $query)){
            ...
            $output = 1;
            $query = "INSERT INTO bitacora VALUES(NULL,NOW(),".$_SESSION['idusuarios'].",'A','Mantenimiento de Departamentos',".
        ...
        if ($cuantos==1){
            ...
            if (!mysqli_query($connect, $query)){
                ...
                $query = "INSERT INTO bitacora ".
                         "VALUES(NULL,NOW(),".$_SESSION['idusuarios'].",'C',".
    ...
    case 5:
        ...
        $result = mysqli_query($connect, $query);
            if (!mysqli_query($connect, $query)){
                ...
                $output = 1;
                $query = "INSERT INTO bitacora ".
                         "VALUES(NULL,NOW(),".$_SESSION['idusuarios'].",'C',NULL,".
